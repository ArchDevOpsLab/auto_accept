class Messaging 
	...
	def click_message_button
		$browser.element(:xpath => ProfilePage.new.get("message_button")).wait_until_present.click 
	end

	def wait_for_message_box
		$browser.element(:xpath => ProfilePage.new.get("message_box")).wait_until_present
